...
export default function NotificationArea({name,followers,twittUsername,isTwitterVerified}) {
  ...
  return (
    <>
      <div onClick={setOpenModal} className={`${isTwitterVerified ? 'bg-[#9e9c9b]' : 'bg-[#241008]'} text-white transition-all flex gap-2 items-center content-center px-8 py-2 rounded-md text-[16px] hover:rounded-none cursor-pointer w-fit`}>
